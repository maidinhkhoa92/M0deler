      ...
      <div className="d-flex flex-column flex-lg-row flex-column-fluid">
        <div className="d-flex flex-lg-row-fluid">
          <div className="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
            <img className="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-5 mb-lg-5" src="/media/logos/default.png" alt="" />
            <img className="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-5 mb-lg-5" src="/media/logos/default.png" alt="" />
            <h1 className="text-gray-800 fs-2qx fw-bold text-center mb-7">Sandboxes To Go</h1>
            <div className="text-gray-600 fs-base text-center fw-semibold">Model your digital economy using sophisticated<br/> prediction tools, analytics and a Python library. <br/>M0deler helps you model a virtual economy with CBDCs and digital currencies<br/> and share and use models from others.</div>
          </div>
        </div>
